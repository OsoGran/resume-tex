...
\textbf{Languages:} C (Expert), C#, MATLAB, Bash, Python, Zig
\textbf{Communications Protocols:} ARINC 429, SPI, I2C, UART, RS-232
\textbf{Requirement Managment:} Rational DOORS, No Magic Cameo
\textbf{Version Control:} Serena Dimensions, Git, SVN
\textbf{Development:} MATLAB Simulink and Embedded Coder, NXP Codewarrior, NI LabWindows/CVI, VS-Code
...
% experience section
\section*{Experience}
\textbf{Senior Flight Controls Systems/Software Engineer,} \href{https://www.bellflight.com/}{Bell Textron, Inc} -- Fort Worth, TX \hfill January 2022 -- Present \\
\vspace{-9pt}
\begin{itemize}
...
\textbf{Communications and Signals Engineering Intern,} \href{https://www.norfolksouthern.com/}{Norfolk Southern Railway} -- Birmingham, AL \hfill May 2018 -- August 2018 \\
\vspace{-9pt}
\begin{itemize}
