...
\textbf{Languages:} C, C++, C\#, Bash, Python, Zig, MATLAB\\
\textbf{Development:} MATLAB Simulink/Embedded Coder, NXP Codewarrior, NI LabWindows/CVI, VS Code\\
\textbf{Version Control:} Git, Serena Dimensions, Subversion\\
...
\textbf{Requirement Management:} Rational DOORS, No Magic Cameo\\
