...
\textbf{Soft Skills:} Context Switching, Strong Communicator, Ambitious, Leader, Independent,\\
...
\vspace{-9pt}
\begin{itemize}
  \item Delivered application ahead of schedule and under budget as the scrum master of a team of 10 developers
  \item Spearheaded multi-system software integration events with an international vendor while under an highly compressed schedule 
  \item Mastered context-switching by developing software while being both a scrum master for one team and product owner for another
  \item Demonstrated features regularly and clearly to stakeholders and leadership
  \item Utilized AI to prototype designs and reduce time researching tooling documentation
  ...
  \item Wrote memory-safe and high quality object-oriented software in C++ running on an RTOS
